...
import { createDevice, fetchDevices, updateDevice, deleteDevice as removeDevice } from '@/services/DevicesService'
...
<template>
  <main class="pb-8 pr-4">
    <div class="flex flex-col gap-2">
      ...
      <div class="flex flex-col gap-2">
        <div class="flex items-center justify-between gap-6">
          ...
          <base-button class="w-40 justify-between rounded-md" >
    ...
    <BaseButton @click="newDevice({
      id: 46,
      device_id: 'device-46',
      category: 'category',
    })">New Device</BaseButton>
  </main>
</template>
