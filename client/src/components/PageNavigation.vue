...
<template>
  <section class="fixed left-0 top-0 h-screen w-64 bg-accent-800 pl-4">
    <h1 class="w-min text-3xl font-light text-accent-400">liltest</h1>
    <nav class="mt-16 flex flex-col gap-2">
      <router-link
        to="/devices"
        :aria-expanded="$route.name === 'devices'"
        class="text-md fill-white-100 hover:fill-accent-500 gap-2 aria-expanded:fill-accent-500 items-center  inline-flex nav_item__rounded relative z-10 rounded-l-xl py-1.5 pl-4 pr-2 leading-10 text-white-100 hover:z-50 hover:cursor-pointer hover:bg-primary-300 hover:text-accent-900 hover:shadow-xl hover:transition-colors hover:duration-200 aria-expanded:bg-primary-200 aria-expanded:text-accent-900 aria-expanded:duration-0 dark:hover:bg-primary-200 dark:hover:text-white-100 dark:aria-expanded:text-white-100"
        ><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 -960 960 960"><path d="M80-160v-120h80v-440q0-33 23.5-56.5T240-800h600v80H240v440h240v120zm520 0q-17 0-28.5-11.5T560-200v-400q0-17 11.5-28.5T600-640h240q17 0 28.5 11.5T880-600v400q0 17-11.5 28.5T840-160zm40-120h160v-280H640zm0 0h160z"/></svg>Configure Devices</router-link
      >
      <router-link
        to="/flows"
        :aria-expanded="$route.name === 'flows'"
        class="text-md fill-white-100 hover:fill-accent-500 aria-expanded:fill-accent-500 nav_item__rounded items-center relative z-10 inline-flex gap-2 rounded-l-xl py-1.5 pl-4 pr-2 leading-10 text-white-100 hover:z-50 hover:cursor-pointer hover:bg-primary-300 hover:text-accent-900 hover:shadow-xl hover:transition-colors hover:duration-200 aria-expanded:bg-primary-200 aria-expanded:text-accent-900 aria-expanded:duration-0 dark:hover:bg-primary-200 dark:hover:text-white-100 dark:aria-expanded:text-white-100"
