    ...
    >
      <ul class="w-full">
        <li
          ...
          :key="device.id"
          class="flex w-full items-center justify-between gap-2 rounded-md p-2 hover:cursor-pointer hover:bg-[#e3e3e3]"
        >
          <div class="w-full">
            {{ device.name }}
          </div>
          <BaseButton
            variant="secondary"
            class="group flex h-12 w-12 items-center justify-center rounded-full border-[#000000] bg-opacity-0 p-0 text-error shadow-none hover:bg-error active:bg-[#9c1c1c]"
          >
            <i
