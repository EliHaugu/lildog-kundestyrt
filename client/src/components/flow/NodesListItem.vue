...
<template>
  ...
  >
    <p>{{ node.data.label }}</p>
    <base-button @click="openModal" variant="icon" aria-label="Edit node" class="ml-auto h-7 items-center">
      <edit-pen class="fill-accent-900 dark:fill-white-100" />
    </base-button>
    <base-button @click="deleteNode" variant="icon" aria-label="Delete node" class="mr-1 h-7 items-center">
